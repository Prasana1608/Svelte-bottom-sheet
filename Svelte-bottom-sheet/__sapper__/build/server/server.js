...
const css$1 = {
	code: ".green.svelte-b01cre{background:linear-gradient(106.64deg, #1BAF0F 0%, #65CD76 34.26%, #2BCF59 70.31%, #36A900 102.49%)}.coin-place.svelte-b01cre{background-image:url(\"../../static/coin.png\");background-size:110px, cover;background-repeat:no-repeat;background-position:center}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"\\n<script>\\n\\timport BottomSheet from \\\"../components/BottomSheet.svelte\\\";\\n\\tlet open = false;\\n\\tlet showModal = false;\\n  import Header from \\\"../components/Header.svelte\\\";\\n</script>\\n<div class=\\\"flex justify-center\\\"><button on:click={() => open = true} class=\\\"p-4 bg-orange-300 text-white text-center text-xl my-20 mx-auto max-w-64 w-64 rounded-lg\\\">\\n\\tBottom sheet {open ? 'opened' : 'closed'}\\n  </button>\\n</div>\\n  <BottomSheet class=\\\"w-full px-4\\\" bind:open>\\n\\t<div class=\\\"white-sheet w-full bg-white rounded-lg pb-60\\\">\\n\\t\\t<div class=\\\"coin-place pt-20\\\">\\n\\t\\t\\t<p class=\\\"text-xl leading-6 text-coin-brown font-extrabold text-center\\\">5283</p>\\n\\t\\t\\t<p class=\\\"text-xs leading-4 font-medium text-center\\\">COINS</p>\\n\\t\\t</div>\\n\\t\\t<p class=\\\"text-center pt-16\\\">Great order! You’re all Green!</p>\\n\\t\\t<div class=\\\"flex px-20 justify-between items-center w-full mt-2\\\">\\n\\t\\t\\t<div class=\\\"green text-lg leading-6 px-2 py-1 bg-green-400 rounded text-white\\\">Green</div>\\n\\t\\t\\t<div class=\\\"green text-lg leading-6 px-2 py-1 bg-green-400 rounded text-white\\\">Green</div>\\n\\t\\t\\t<div class=\\\"green text-lg leading-6 px-2 py-1 bg-green-400 rounded text-white\\\">Green</div>\\n\\t\\t</div>\\n\\t</div>\\n\\t<div class=\\\"green-button\\\">\\n\\t\\tGo Back to Beat\\n\\t</div>\\n\\t<div class=\\\"today-coins\\\">\\n\\n\\t</div>\\n  </BottomSheet>\\n  \\n  <style>\\n\\t  .green{\\n\\t\\tbackground: linear-gradient(106.64deg, #1BAF0F 0%, #65CD76 34.26%, #2BCF59 70.31%, #36A900 102.49%);\\n\\t  }\\n\\t  .coin-place{\\n\\t\\t  background-image: url(\\\"../../static/coin.png\\\");\\n\\t\\t  background-size: 110px, cover;\\n\\t\\t  background-repeat: no-repeat;\\n    \\t  background-position: center;\\n\\n\\t  }\\n  </style>\"],\"names\":[],\"mappings\":\"AAiCG,oBAAM,CAAC,AACR,UAAU,CAAE,gBAAgB,SAAS,CAAC,CAAC,OAAO,CAAC,EAAE,CAAC,CAAC,OAAO,CAAC,MAAM,CAAC,CAAC,OAAO,CAAC,MAAM,CAAC,CAAC,OAAO,CAAC,OAAO,CAAC,AAClG,CAAC,AACD,yBAAW,CAAC,AACX,gBAAgB,CAAE,IAAI,uBAAuB,CAAC,CAC9C,eAAe,CAAE,KAAK,CAAC,CAAC,KAAK,CAC7B,iBAAiB,CAAE,SAAS,CACzB,mBAAmB,CAAE,MAAM,AAE/B,CAAC\"}"
};
...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `<div class="flex justify-center"><button class="p-4 bg-orange-300 text-white text-center text-xl my-20 mx-auto max-w-64 w-64 rounded-lg">
		  ...
		  ${validate_component(BottomSheet, 'BottomSheet').$$render($$result, { class: "w-full px-4", open: open }, {
			...
			default: () => `
			<div class="white-sheet w-full bg-white rounded-lg pb-60">
				<div class="coin-place pt-20 svelte-b01cre">
					<p class="text-xl leading-6 text-coin-brown font-extrabold text-center">5283</p>
					<p class="text-xs leading-4 font-medium text-center">COINS</p>
				</div>
				<p class="text-center pt-16">Great order! You’re all Green!</p>
				<div class="flex px-20 justify-between items-center w-full mt-2">
					<div class="green text-lg leading-6 px-2 py-1 bg-green-400 rounded text-white svelte-b01cre">Green</div>
					<div class="green text-lg leading-6 px-2 py-1 bg-green-400 rounded text-white svelte-b01cre">Green</div>
					<div class="green text-lg leading-6 px-2 py-1 bg-green-400 rounded text-white svelte-b01cre">Green</div>
				</div>
			</div>
			<div class="green-button svelte-b01cre">
				Go Back to Beat
			</div>
			<div class="today-coins">
